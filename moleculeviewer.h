...
class MoleculeViewer : public Application
{
public:
    MoleculeViewer(const std::vector<std::string> &args);
    ~MoleculeViewer();
...
private:
    ...
    {
    public:
        Worker(MoleculeViewer &hologram, int index, int object_begin, int object_end);
